...
See also the utility's help option. `antdaza-blockchain-stats --help`

From the command line run:

`$ antdaza-blockchain-stats`
...
- `antdaza-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `antdaza-blockchain-stats | save-to-database.sh`
