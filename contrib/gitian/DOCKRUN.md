...
You'll also need to clone the antdaza repository and navigate to the `contrib/gitian` directory:

```bash
git clone https://github.com/antfodaza/antdaza.git
cd antdaza/contrib/gitian
```
...
* a fork of the [gitian.sigs](https://github.com/antfodaza/gitian.sigs/) repo on your GitHub account.
