...
RUN	git clone https://github.com/antfodaza/gitian.sigs.git sigs; \
  ...
  git clone https://github.com/antfodaza/antdaza
...
if [ ! -d sigs ]; then
	git clone https://github.com/antfodaza/gitian.sigs.git sigs
	cd sigs
